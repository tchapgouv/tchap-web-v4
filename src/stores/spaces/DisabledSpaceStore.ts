...
This file is a copy of SpaceStore.ts from matrix-react-sdk 1.10.14, with customisations :
 - spacesEnabled = false
*/
...
import { AsyncStoreWithClient } from "matrix-react-sdk/src/stores/spaces/../AsyncStoreWithClient";
import defaultDispatcher from "matrix-react-sdk/src/stores/spaces/../../dispatcher/dispatcher";
import RoomListStore from "matrix-react-sdk/src/stores/spaces/../room-list/RoomListStore";
import SettingsStore from "matrix-react-sdk/src/stores/spaces/../../settings/SettingsStore";
import DMRoomMap from "matrix-react-sdk/src/stores/spaces/../../utils/DMRoomMap";
import { FetchRoomFn } from "matrix-react-sdk/src/stores/spaces/../notifications/ListNotificationState";
import { SpaceNotificationState } from "matrix-react-sdk/src/stores/spaces/../notifications/SpaceNotificationState";
import { RoomNotificationStateStore } from "matrix-react-sdk/src/stores/spaces/../notifications/RoomNotificationStateStore";
import { DefaultTagID } from "matrix-react-sdk/src/stores/spaces/../room-list/models";
import { EnhancedMap, mapDiff } from "matrix-react-sdk/src/stores/spaces/../../utils/maps";
import { setDiff, setHasDiff } from "matrix-react-sdk/src/stores/spaces/../../utils/sets";
import { RoomViewStore } from "matrix-react-sdk/src/stores/spaces/../RoomViewStore";
import { Action } from "matrix-react-sdk/src/stores/spaces/../../dispatcher/actions";
import { arrayHasDiff, arrayHasOrderChange } from "matrix-react-sdk/src/stores/spaces/../../utils/arrays";
import { reorderLexicographically } from "matrix-react-sdk/src/stores/spaces/../../utils/stringOrderField";
import { TAG_ORDER } from "matrix-react-sdk/src/stores/spaces/../../components/views/rooms/RoomList";
import { SettingUpdatedPayload } from "matrix-react-sdk/src/stores/spaces/../../dispatcher/payloads/SettingUpdatedPayload";
import {
    isMetaSpace,
    ISuggestedRoom,
    MetaSpace,
...
import { getCachedRoomIDForAlias } from "matrix-react-sdk/src/stores/spaces/../../RoomAliasCache";
import { EffectiveMembership, getEffectiveMembership } from "matrix-react-sdk/src/stores/spaces/../../utils/membership";
import {
...
import { PosthogAnalytics } from "matrix-react-sdk/src/stores/spaces/../../PosthogAnalytics";
import { ViewRoomPayload } from "matrix-react-sdk/src/stores/spaces/../../dispatcher/payloads/ViewRoomPayload";
import { ViewHomePagePayload } from "matrix-react-sdk/src/stores/spaces/../../dispatcher/payloads/ViewHomePagePayload";
import { SwitchSpacePayload } from "matrix-react-sdk/src/stores/spaces/../../dispatcher/payloads/SwitchSpacePayload";
import { AfterLeaveRoomPayload } from "matrix-react-sdk/src/stores/spaces/../../dispatcher/payloads/AfterLeaveRoomPayload";
...
const spacesEnabled = false; //!SettingsStore.getValue("showCommunitiesInsteadOfSpaces");
