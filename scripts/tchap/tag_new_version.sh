...
echo "Don't forget to open a PR and have it validated. Verify with the Review App that the application builds and runs correctly. If not you should deleted the created tag and the release"
