...
const TchapRedListSettings: React.FC<TchapRedListSettingsProps> = () => {
    ...
    return (
        <SettingsSubsection heading={_t("settings|general|redlist")} stretchContent>
            <div className="mx_SettingsFlag">
                <label className="mx_SettingsFlag_label" htmlFor="redList-toggle">
                    ...
                    <div className="mx_SettingsFlag_microcopy">{_t("settings|general|redlist_description")}</div>
                </label>
                <ToggleSwitch
                    id="redList-toggle"
                    checked={isOnRedList}
