...
} from "~tchap-web/src/components/views/settings/shared/SettingsSubsection";
...
const TchapMailSignature: React.FC<TchapMailSignatureProps> = (props) => {
    ...
    return (
        <SettingsSubsection heading={_t("settings|general|mail_signature")} stretchContent>
            ...
            <CopyableBrut getElementToCopy={signatureHtmlCopy} aria-labelledby={"mail-signature"}>
                <div
                    className="mx_TchapMailSignature"
                    dangerouslySetInnerHTML={{ __html: generateSignatureHtml(props.userPermalink) }}
                />
            </CopyableBrut>
        </SettingsSubsection>
    );
